...
public class IncomeDAO {
    ...
    private static final String businessColumn = "business";
    ...
    public static void insertIncome(Income income) {
        //update database
        String query = "INSERT INTO income(date, salary, help, business, passive, other) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        try (Connection connection = Database.connect()) {
            ...
            statement.setFloat(4, income.getBusiness());
